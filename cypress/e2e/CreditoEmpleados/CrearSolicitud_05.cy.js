...
describe('Primer conjunto de casos de prueba',function()
{
    ...
    it('LOGUIN ALIADO DIGITAL', function(){
        ...
        cy.get('#tipo_identificacion').click(); // Abre el componente de selección
     
        cy.get('[name="numero_identificacion"]').type('26527715')
        ...
        cy.get('[name="lugar_expedicion_documento"]').type('BOGOTA')
        cy.get('div[id^="react-select-"]').click()
        .wait(1000);
